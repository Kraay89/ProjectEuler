...
print("The natural numbers are:", list(natural_numbers))
print("The squares of the natural numbers are: ", natural_numbers_squares)
print("The sum of the squares of the natural numbers is: ",
      natural_numbers_squares_sum)
print("The square of the sums of the natural numbers is: ",
      natural_numbers_sums_square)
